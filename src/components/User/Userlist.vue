    ...
    <el-table :data="list" border stripe size="small" style="width:95%;">
      ...
      <el-table-column label="操作" min-width="200" align="center">
        <template slot-scope="scope">
          ...
          <el-button type="warning" size="mini" v-if="scope.row.bind==0" @click="bindshop(scope.$index, scope.row)" v-show="checkper1">绑定店铺</el-button>

          <el-button type="danger" size="mini" v-if="scope.row.bind!==0" @click="unbindshop(scope.$index, scope.row)" v-show="checkper1">解绑店铺</el-button>
        </template>
      </el-table-column>
    </el-table>

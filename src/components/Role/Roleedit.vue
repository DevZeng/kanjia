...
<!--           <tr>
          ...
          <tr>
            <td class="ltd">商铺</td>
            <td class="rtd">
              <el-checkbox @change="xzchange" true-label='storeAdd' false-label='storeAdd1a' checked>店铺地区</el-checkbox>
              ...
              <el-checkbox @change="xzchange" true-label='storecount' false-label='storecount1a' checked>交易统计</el-checkbox>
...
<!--           <tr>
          ...
          <tr>
            ...
            <td class="rtd">
              <el-checkbox @change="xzchange" true-label='iproductListAll' false-label='iproductListAll1a' checked>商品列表</el-checkbox>
              ...
              <el-checkbox @change="xzchange" true-label='iDrawset' false-label='iDrawset1a' checked>抽奖设置</el-checkbox>
            </td>
          </tr>
<!--           <tr>
            <td class="ltd">优惠券</td>
      ...
      <table border="1" cellspacing="0" style="border-collapse:collapse;border:#ddd;">
        ...
        <tr>
          ...
          <td class="rtd">
            ...
            <el-checkbox @change="xzchange" true-label='userbind' false-label='userbind1a' checked>绑定店铺</el-checkbox>
          </td>
        </tr>
        <tr>
...
<!--       <div class="tablebox">
      ...
      <div class="tablebox">
        <table border="1" cellspacing="0" style="border-collapse:collapse;border:#ddd;">
          ...
          <tr>
            <td class="ltd">首页弹窗</td>
            <td class="rtd">
              <el-checkbox @change="xzchange" true-label='indexmodal' false-label='indexmodal1a' checked>首页弹窗</el-checkbox>
            </td>
          </tr>

          <tr>
            <td class="ltd">合作申请</td>
            <td class="rtd">
              <el-checkbox @change="xzchange" true-label='joinapply' false-label='joinapply1a' checked>合作申请</el-checkbox>
            </td>
          </tr>

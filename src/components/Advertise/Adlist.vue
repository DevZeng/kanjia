     ...
     <el-row>
      ...
      <el-tabs v-model="activeName" type="card">
        <el-tab-pane label="首页轮播" name="banner">
         ...
         <el-form :inline="true">
          <el-form-item>
            <el-button type="primary" size="small" @click="newone">新增轮播</el-button>
          </el-form-item>
        </el-form>
      ...
      getposter(){
        ...
        posterGet(allParams).then((res) => {
          ...
          if(res.data.proxy_poster){
            this.otherpost[3].pic=res.data.proxy_poster
          }else{
            this.otherpost[3].pic='../../../static/images/default2.png'
          }

          if(res.data.score_poster){
            this.otherpost[0].pic=res.data.score_poster
          }else{
            this.otherpost[0].pic='../../../static/images/default.png'
          }

          if(res.data.prize_poster){
            this.otherpost[1].pic=res.data.prize_poster
          }else{
            this.otherpost[1].pic='../../../static/images/default.png'
          }

          if(res.data.idnex_poster){
            this.otherpost[2].pic=res.data.idnex_poster
          }else{
            this.otherpost[2].pic='../../../static/images/default.png'
          }

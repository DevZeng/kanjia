...
import Shopcount from '@/components/Shop/Shopcount'
...
import Cooperation from '@/components/Shop/Cooperation'
...
import Modalset from '@/components/Setting/Modalset'
...
let router = new Router({
    ...
    routes: [{
        ...
        children: [
        {path: '/Shop/Shopadd',component: Shopadd,name: '商店地区',menuShow: true,meta:{permission: 'storeAdd'}},
        ...
        {path: '/Shop/Shopcount',component: Shopcount,name: '交易统计',menuShow: true,meta:{permission: 'storecount'}}, 
        {path: '/Shop/Settleapply',component: Settleapply,name: '代理申请',menuShow: true,meta:{permission: 'settleList'}},
...
{path: '/Good/Goodtype',component: Goodtype,name: '商品分类',menuShow: true,meta:{permission: 'productTypeList'}}, 
    ...
    }, 
    {
        ...
        {path: '/Integral/Igoodlist',component: Igoodlist,name: '积分商品',menuShow: true,meta:{permission: 'iproductListAll'}}, 
        {path: '/Integral/Idraw',component: Idraw,name: '抽奖设置',menuShow: true,meta:{permission: 'iDrawset'}}, 
        ]
    },
    {
        leaf: true,
...

    {
        ...
        {path: '/Kan/Kangood',component: Kangood,name: '活动列表',menuShow: true,meta:{permission: 'storeBargainPromotions'}},//storeBargainPromotions 
        {path: '/Kan/Kancheck',component: Kancheck,name: '待审核',menuShow: true,meta:{permission: 'checkBargainPromotions'}},//checkBargainPromotions 
        {path: '/Kan/Kanchange',component: Kanchange,name: ' 编辑活动',menuShow: false,meta:{permission: ''}}, 
        {path: '/Kan/Kanpass',component: Kanpass,name: '通过列表',menuShow: true,meta:{permission: 'allBargainPromotions'}},//allBargainPromotions        
        ]
    }, {
        leaf: true,
        path: '/',
    ...
    },
    {
        ...
        iconCls: 'iconfont menu-guanggao',
        children: [
        {path: '/Shop/Cooperation',component: Cooperation,name: '合作申请',menuShow: true,meta:{permission: 'joinapply'}}
        ]
    },
    //  {
    //     // leaf: true,
    ...
    // },
    {
        ...
        {path: '/Setting/Modalset',component: Modalset,name: '首页弹框',menuShow: true,meta:{permission: 'indexmodal'}},

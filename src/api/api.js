...
let hosturl ='https://service.cangshubuy.com/'
...
export const sapplies = params => { return axios.get(`${base3}/store/applies`+`${params}`).then(res => res.data)}
export const applyCheck = params => { return axios.get(`${base3}/check/apply`+`${params}`).then(res => res.data)}


//店铺地区
export const shopaddGet = params => { return axios.get(`${base3}/cities`+`${params}`).then(res => res.data)}

export const shopaddPost = params => { return axios.post(`${base3}/city`, params).then(res => res.data)}

export const shopaddDel = params => { return axios.delete(`${base3}/city`+`${params}`).then(res => res.data)}



export const shopaddGet1 = params => { return axios.get(`${ hosturl+'api/v3'}/cities`+`${params}`).then(res => res.data)}
...
export const shopcount = params => { return axios.get(`${base}/count/stores`+`${params}`).then(res => res.data)}
...
export const typestate = params => { return axios.get(`${base}/check/product/type`+`${params}`).then(res => res.data)}//热门
...
export const modalPost = params => { return axios.post(`${base}/dialog/config`, params).then(res => res.data)}

export const modalGet = params => { return axios.get(`${base}/dialog/config`+`${params}`).then(res => res.data)}



export const timesPost = params => { return axios.post(`${base3}/sys/config`, params).then(res => res.data)}

export const timesGet = params => { return axios.get(`${base3}/sys/configs`+`${params}`).then(res => res.data)}
...
// export const Kanhot = params => { return axios.get(`${base1}/hot/bargain/promotion`+`${params}`).then(res => res.data)}

export const Kanoffer = params => { return axios.get(`${base}/offer`+`${params}`).then(res => res.data)}
